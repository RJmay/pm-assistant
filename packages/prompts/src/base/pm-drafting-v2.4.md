...
- **Form 4** — Refund of rental bond; **Form 16** — Dispute resolution request (bond disputes)
...
- Bond disputes: a party lodges a Refund of rental bond (Form 4); a party who disagrees lodges a Dispute resolution request (Form 16) with the RTA (unresolved disputes can go to QCAT).
