...
- **Forms:** general tenancy agreement (**Form 18a**), and the other RTA forms relevant to drafting — entry notice (**Form 9**), notice to remedy breach (**Form 11**), notice to leave (**Form 12**), notice of intention to leave (**Form 13**), disputed bond (**Form R12**). Forms were updated under the 2025 Regulation (18a, 18b, R18) — store form identifiers + the version/source.
