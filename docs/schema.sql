...
-- ============================================================================
-- SMS MESSAGES (added in migration 0019) — Phase 5, spec §11
-- ============================================================================
-- Inbound SMS captured, classified, linked to context, given a drafted reply
-- for the PM to review + send (never auto-sent, §13). Escalation cases flagged
-- for a human. Full transcript retained for audit.
-- ============================================================================
